...
@Override
	...
	catch (EntityExistsException exe){ throw new BrokerException("Duplicate Customer");
	}
	...
	public void updateCustomer(Customer cust) throws BrokerException {
    	...
    	if (customer==null){
    		throw new BrokerException("Customer : " + customer + " not found");
 ...
 */
    ...
    public void addStock(Stock stock) throws BrokerException {
    	...
    	catch (EntityExistsException exe){ throw new BrokerException("Duplicate Stock : " + stock.getSymbol());
    	}
    }
    public void updateStock(Stock stock) throws BrokerException {
